...
//
// impl is the actual class (not the string '@cap-js/postgres'): CAP resolves
// a string impl via require.resolve() at construction time, invisible to
// Vercel's file tracer — the package would silently be missing from the
// bundle despite being require()'d right here, one line up.
